    ...
    <body>
        ...
        <div id="customer-chat-widget" class="customer-chat customer-chat-widget loading-screen">
            ...
            <div class="customer-chat-header">
               ...
               <!--  <div class="customer-chat-header-indicator" ><span class="online"><i class="icon fa fa-circle"></i></span>
                </div> -->
                ...
                <div id="customer-chat-button-settings" class="customer-chat-header-button"><i class="fa fa-cogs"></i></div>
            ...
            <div id="customer-chat-content-login-form" class="customer-chat-content">
                ...
                <div class="form">
                    <img src="<?php echo $app->asset('img/live-chat.png') ?>" width="80">
            ...
            <div id="customer-chat-content-chat-box" class="customer-chat-content chat-box file-drop-zone">
                ...
                <div class="customer-chat-content-message-input">
                    ...
                    <label class="file-button" for="file-input">
                        ...
                        <i class="fa fa-paperclip fa-flip-horizontal" style="color:#003478"></i>
            ...
            <div id="customer-chat-content-contact-form" class="customer-chat-content">
                ...
                <div class="form">
                    ...
                    <div class="customer-chat-content-info">
                     ...
                     <div class="office-time"><?php echo $app->trans('officeTime') ?></div>
                    <div class="customer-chat-content-message-input">
        ...
        <a id="mobile-widget" class="customer-chat-header" href="<?php echo $app->path('Widget:mobileView') ?>" target="_top"><i class="fa fa-comments fa-3x"></i></a>
